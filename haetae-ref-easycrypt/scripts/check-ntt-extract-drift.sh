...
SOURCE="$ROOT_DIR/haetae-ref-jasmin/jasmin/hpoly.jazz"
OUT_DIR="$PROJECT_DIR/easycrypt/extract/ntt"
...
printf 'PASS: target NTT extraction has zero regeneration drift (%s files)\n' \
