...
- **Mode-2 matrix-arithmetic and finalization milestone:** the actual extracted
  ...
  now closes the exact one-stage lift below this theorem, but the eight-round
  ...
  termination, the eight-round machine-to-ideal lift and
...
- **P3 remains open:** strengthen the fixed-mode packed-output/first-attempt
  ...
  eight-round inductions extending the proved initialization,
  one-butterfly, `k`-prefix, block-prefix, and stage endpoints through the exact ideal schedule,
