...
finalization, totality, root-table rounding, and proof-only
sampler-to-finalizer composition writes
...
The `2026-07-29T16:42:38Z` run records the canonical source hash; zero drift for
...
imported dependency hashes; 37/37 fresh `-no-eco` compilations; and clean
