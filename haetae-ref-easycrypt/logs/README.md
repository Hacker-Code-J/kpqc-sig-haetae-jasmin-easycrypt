...
finalization, totality, and proof-only sampler-to-finalizer composition writes
...
The `2026-07-28T12:48:20Z` run records the canonical source hash; zero drift for
...
imported dependency hashes; 30/30 fresh `-no-eco` compilations; and clean
