...
rewrite /NTT_Fq.poly_repr /NTT_Fq.barray256_to_poly Array256.initiE 1:/#.
rewrite (hfreeze i).
have hprev : p.[i] = word_to_coeff (BArray1024.get32 before i).
  exact (NTT_Fq.poly_repr_get before p i hbefore hi).
by rewrite -hprev.
qed.
