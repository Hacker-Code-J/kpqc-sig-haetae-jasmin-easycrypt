...
%		\draw[fill=teal!15, rounded corners=4pt] (15,-1.5) rectangle (16,-1) node[below right] {Automation focus};
%		\draw[fill=orange!15, rounded corners=4pt] (15,-2.25) rectangle (16,-1.75) node[below right] {Expressiveness focus};
%		\draw[fill=yellow!15, rounded corners=4pt] (15,-3) rectangle (16,-2.5) node[below right] {Security only};
		...
		\node[draw=black, fill=white, rounded corners=4pt, minimum height=.75cm] (AutoGP) at (10,-1) {AutoG\&P}; % 15
		\node[draw=black, fill=cyan!20, rounded corners=4pt, minimum height=.75cm] (CertiCrypt) at (4,-2) {CertiCrypt}; % 9
		\node[draw=black, fill=white, rounded corners=4pt, minimum height=.75cm] (CryptHOL) at (12,-1) {CryptHOL}; % 17
		\node[draw=black, fill=cyan!20, rounded corners=4pt, minimum height=.75cm] (CryptoVerif) at (3,-1) {CryptoVerif}; % 8
		\node[draw=black, fill=cyan!20, rounded corners=4pt, minimum height=.75cm] (EasyCrypt) at (6,-2) {EasyCrypt}; % 11
		\node[draw=black, fill=cyan!20, rounded corners=4pt, minimum height=.75cm] (F7) at (6,-1) {F7}; % 11
		\node[draw=black, fill=cyan!20, rounded corners=4pt, minimum height=.75cm] (F) at (11,-2) {F*}; % 16
		\node[draw=black, fill=cyan!20, rounded corners=4pt, minimum height=.75cm] (FCF) at (10,-2) {FCF}; % 15
		\node[draw=black, fill=white, rounded corners=4pt, minimum height=.75cm] (ZooCrypt) at (8,-1) {ZooCrypt}; % 13
