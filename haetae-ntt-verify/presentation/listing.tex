...
\lstdefinestyle{c}{
	...
	keywordstyle=[4]\color{purple!50!black}\bfseries,
	stringstyle=\color{red!70},               % Strings in reddish color
	commentstyle=\color{green!50!black}, % Comments in italic green-black
%	numberstyle=\tiny\color{gray},            % Line numbers in tiny gray font
%	numbers=left,                             % Line numbers on the left
%	stepnumber=1,                             % Number every line
%	numbersep=4pt,                            % Space between line numbers and code
...
%	frame=single,                             % Single-line frame around the code
	...
	morekeywords=[4]{lu},
%	postbreak={\;\textcolor{red}{$\hookrightarrow$}\;},
}
...
\definecolor{coqBlue}{rgb}{0.0,0.0,0.6}
\definecolor{coqGreen}{rgb}{0.0,0.5,0.0}
\definecolor{coqGray}{rgb}{0.95,0.95,0.95}

% Define the rocq style
\lstdefinestyle{rocq}{
%	language=Coq,                 % use Coq's Gallina syntax
	basicstyle      = \ttfamily\small,     % code font & size
	keywordstyle    = \bfseries\color{coqBlue},   % Gallina keywords
	commentstyle    = \itshape\color{coqGreen},  % comments
	stringstyle     = \color{red},              % strings (if any)
	morekeywords    = {Lemma, Theorem, Fixpoint, Inductive, Definition, Proof, Qed, match, with, end},
	numbers         = left,                      % line numbers on the left
	numberstyle     = \tiny\color{gray},
	stepnumber      = 1,                         
	numbersep       = 5pt,                       
%	backgroundcolor = \color{coqGray},           % light gray background
	frame           = single,                    
	breaklines      = true,                      
