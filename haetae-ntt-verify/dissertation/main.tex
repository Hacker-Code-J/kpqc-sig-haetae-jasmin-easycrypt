...
\usepackage[backend=bibtex8, style=alphabetic, sorting=anyt, maxnames=4]{biblatex}
...
\lstdefinelanguage{Jasmin}{
  keywords={fn, export, inline, reg, stack, ptr, u8, u16, u32, u64, u128,
            ...
            param, global, mut, require, const, ui64},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  sensitive=true,
}
...
\newcommand{\haetae}{\texorpdfstring{\textup{HAETAE}}{HAETAE}}
...
\include{chapters/ch03_haetae_ntt}
\include{chapters/ch04_formal_framework}
\include{chapters/ch05_field_ring}
\include{chapters/ch06_montgomery}
\include{chapters/ch07_ntt_spec}
\include{chapters/ch08_algebra}
\include{chapters/ch09_jasmin_impl}
\include{chapters/ch10_refinement}
\include{chapters/ch11_end_to_end}
\include{chapters/ch12_conclusion}
