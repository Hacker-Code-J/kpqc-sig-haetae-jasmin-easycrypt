...
module M = {
  ...
  proc _poly_ntt_stage_128 (rp:BArray1024.t) : BArray1024.t = {
    ...
    block <- 0;
    while ((block < 1)) {
      zeta_0 <- (BArray1024.get32 zetasp (1 + block));
      start <- block;
      start <- (start `<<` 8);
      j <- 0;
      while ((j < 128)) {
  ...
  proc _poly_ntt_stage_64 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 2)) {
      zeta_0 <- (BArray1024.get32 zetasp (2 + block));
      start <- block;
      start <- (start `<<` 7);
      j <- 0;
      while ((j < 64)) {
  ...
  proc _poly_ntt_stage_32 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 4)) {
      zeta_0 <- (BArray1024.get32 zetasp (4 + block));
      start <- block;
      start <- (start `<<` 6);
      j <- 0;
      while ((j < 32)) {
  ...
  proc _poly_ntt_stage_16 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 8)) {
      zeta_0 <- (BArray1024.get32 zetasp (8 + block));
      start <- block;
      start <- (start `<<` 5);
      j <- 0;
      while ((j < 16)) {
  ...
  proc _poly_ntt_stage_8 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 16)) {
      zeta_0 <- (BArray1024.get32 zetasp (16 + block));
      start <- block;
      start <- (start `<<` 4);
      j <- 0;
      while ((j < 8)) {
  ...
  proc _poly_ntt_stage_4 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 32)) {
      zeta_0 <- (BArray1024.get32 zetasp (32 + block));
      start <- block;
      start <- (start `<<` 3);
      j <- 0;
      while ((j < 4)) {
  ...
  proc _poly_ntt_stage_2 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 64)) {
      zeta_0 <- (BArray1024.get32 zetasp (64 + block));
      start <- block;
      start <- (start `<<` 2);
      j <- 0;
      while ((j < 2)) {
  ...
  proc _poly_ntt_stage_1 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var s:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 128)) {
      zeta_0 <- (BArray1024.get32 zetasp (128 + block));
      start <- block;
      start <- (start `<<` 1);
      j <- 0;
      while ((j < 1)) {
  ...
  proc _poly_invntt_stage_1 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 128)) {
      zeta_0 <- (BArray1024.get32 zetasp (0 + block));
      start <- block;
      start <- (start `<<` 1);
      j <- 0;
      while ((j < 1)) {
  ...
  proc _poly_invntt_stage_2 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
  ...
  proc _poly_invntt_stage_4 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 32)) {
      zeta_0 <- (BArray1024.get32 zetasp (192 + block));
      start <- block;
      start <- (start `<<` 3);
      j <- 0;
      while ((j < 4)) {
  ...
  proc _poly_invntt_stage_8 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 16)) {
      zeta_0 <- (BArray1024.get32 zetasp (224 + block));
      start <- block;
      start <- (start `<<` 4);
      j <- 0;
      while ((j < 8)) {
  ...
  proc _poly_invntt_stage_16 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 8)) {
      zeta_0 <- (BArray1024.get32 zetasp (240 + block));
      start <- block;
      start <- (start `<<` 5);
      j <- 0;
      while ((j < 16)) {
  ...
  proc _poly_invntt_stage_32 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 4)) {
      zeta_0 <- (BArray1024.get32 zetasp (248 + block));
      start <- block;
      start <- (start `<<` 6);
      j <- 0;
      while ((j < 32)) {
  ...
  proc _poly_invntt_stage_64 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 2)) {
      zeta_0 <- (BArray1024.get32 zetasp (252 + block));
      start <- block;
      start <- (start `<<` 7);
      j <- 0;
      while ((j < 64)) {
  ...
  proc _poly_invntt_stage_128 (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var t:W32.t;
    var coeff:W32.t;
    ...
    block <- 0;
    while ((block < 1)) {
      zeta_0 <- (BArray1024.get32 zetasp (254 + block));
      start <- block;
      start <- (start `<<` 8);
      j <- 0;
      while ((j < 128)) {
  ...
  proc _poly_invntt_scale (rp:BArray1024.t) : BArray1024.t = {
    var zetasp:BArray1024.t;
    var zeta_0:W32.t;
    var coeff:W32.t;
    var t:W32.t;
