...
module M(SC:Syscall_t) = {
  ...
  proc __caddq (a:W32.t) : W32.t = {
    var mask:W32.t;
    mask <- a;
    mask <- (mask `|>>` (W8.of_int 31));
    mask <- (mask `&` (W32.of_int 64513));
    a <- (a + mask);
    return a;
  }
  ...
  proc _pack_vk_m5 (vkp:BArray2080.t, bp:BArray8192.t, seedp:BArray32.t,
                    count:W64.t) : BArray2080.t = {
    var i:W64.t;
    var poly:W64.t;
    var coeff_base:W64.t;
    ...
    while ((poly \ult count)) {
      ...
      while ((i \ult (W64.of_int 256))) {
        idx <- coeff_base;
        idx <- (idx + i);
        a <- (BArray8192.get32 bp (W64.to_uint idx));
        vkp <-
        (BArray2080.set8 vkp (W64.to_uint (off + (W64.of_int 0)))
        (truncateu8 a));
        out <- a;
      ...
      coeff_base <- (coeff_base + (W64.of_int 256));
      out_base <- (out_base + (W64.of_int 512));
      poly <- (poly + (W64.of_int 1));
    }
    return vkp;
  }
  ...
  proc _pack_sk_m5 (skp:BArray2752.t, vkp:BArray2080.t, s0p:BArray8192.t,
                    s1p:BArray8192.t, keyp:BArray32.t, vkbytes:W64.t,
                    mcount:W64.t, kcount:W64.t) : BArray2752.t = {
    var i:W64.t;
    var off:W64.t;
  ...
  proc _keypair_finalize_m5 (bp:BArray8192.t, s2hatp:BArray8192.t,
    ...
    i <- (W64.of_int 0);
    while ((i \ult count)) {
      wide <- (sigextu64 (BArray8192.get32 bp (W64.to_uint i)));
      wide <- (wide * (W64.of_int 4214));
      b <@ __montgomery_reduce (wide);
      s2 <- (BArray8192.get32 s2hatp (W64.to_uint i));
      b <- (b + s2);
      wide <- (sigextu64 b);
      wide <- (wide * (W64.of_int 14321));
      wide <- (wide * (W64.of_int 2));
      z <- (W64.of_int 0);
      z <- (z - wide);
      b <@ __montgomery_reduce (z);
      b <@ __caddq (b);
      bp <- (BArray8192.set32 bp (W64.to_uint i) b);
      i <- (i + (W64.of_int 1));
    }
    return bp;
  }
  ...
  proc __kp_api_copy_addr_to_32 (dstp:BArray32.t, srcp:W64.t) : BArray32.t = {
    var i:W64.t;
    var addr:W64.t;
    var b:W8.t;
    i <- (W64.of_int 0);
  ...
  proc __kp_api_copy_2080_to_addr (dstp:W64.t, srcp:BArray2080.t, len:W64.t) : 
  W64.t = {
    var i:W64.t;
    var b:W8.t;
    var addr:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult len)) {
      b <- (BArray2080.get8 srcp (W64.to_uint i));
      addr <- dstp;
      addr <- (addr + i);
      Glob.mem <- (storeW8 Glob.mem (W64.to_uint addr) b);
      i <- (i + (W64.of_int 1));
    }
    return dstp;
  }
  proc __kp_api_copy_2752_to_addr (dstp:W64.t, srcp:BArray2752.t, len:W64.t) : 
  W64.t = {
    var i:W64.t;
    var b:W8.t;
    var addr:W64.t;
    i <- (W64.of_int 0);
    while ((i \ult len)) {
      b <- (BArray2752.get8 srcp (W64.to_uint i));
      addr <- dstp;
      addr <- (addr + i);
      Glob.mem <- (storeW8 Glob.mem (W64.to_uint addr) b);
      i <- (i + (W64.of_int 1));
  ...
  proc _kp_m5_matrix (bp:BArray8192.t, s1hatp:BArray8192.t, ap:BArray32768.t,
                      s1p:BArray8192.t, rows:W64.t, cols:W64.t) : BArray8192.t *
                                                                  BArray8192.t = {
    var count:W64.t;
    var ms:W64.t;
    count <- cols;
  ...
  proc _kp_copy_ntt (dstp:BArray8192.t, srcp:BArray8192.t, count:W64.t) : 
  BArray8192.t = {
    var coeffs:W64.t;
    coeffs <- count;
    coeffs <- (coeffs * (W64.of_int 256));
  ...
  proc _keypair_full_m5 (vkp:BArray2080.t, skp:BArray2752.t, seedp:BArray32.t) : 
  BArray2080.t * BArray2752.t = {
    var seedbuf:BArray128.t;
    var seedbufp:BArray128.t;
    var mat:BArray32768.t;
    var matp:BArray32768.t;
    ...
    var s2:BArray8192.t;
    var s2p:BArray8192.t;
    var s2hat:BArray8192.t;
    var s2hatp:BArray8192.t;
    var kr:W64.t;
    var mr:W64.t;
    var vkbr:W64.t;
    var counter:W64.t;
    ...
    while ((reject <> (W64.of_int 0))) {
      ...
      nonce <- (nonce + mr);
      s2p <@ _kp_polyvec_expand_eta (s2p, seedbufp, nonce, kr);
      counter <- (counter + (W64.of_int 10));
      sv <@ _singular_full (s1p, s2p, 6, 4, 3, 128, 0);
      bound <- (W64.of_int 778065);
      (* Erased call to declassify *)
      (* Erased call to declassify *)
      ms <- (init_msf);
      sv <- (protect_64 sv ms);
  ...
  proc crypto_sign_keypair_internal_mode3_jazz (vkp:BArray2080.t,
                                                skp:BArray2752.t,
                                                seedp:BArray32.t) : BArray2080.t *
                                                                    BArray2752.t = {
    var ms:W64.t;
    ...
    skp <- (protect_ptr skp ms);
    seedp <- (protect_ptr seedp ms);
    (vkp, skp) <@ _keypair_full_m23 (vkp, skp, seedp, 3, 5, 1472, 4, 80, 16,
    852505);
    return (vkp, skp);
  }
  proc crypto_sign_keypair_internal_mode5_jazz (vkp:BArray2080.t,
                                                skp:BArray2752.t,
                                                seedp:BArray32.t) : BArray2080.t *
                                                                    BArray2752.t = {
    var ms:W64.t;
  ...
  proc crypto_sign_keypair_mode2_jazz (vkp:BArray2080.t, skp:BArray2752.t) : 
  BArray2080.t * BArray2752.t = {
    var seed:BArray32.t;
  ...
  proc crypto_sign_keypair_mode3_jazz (vkp:BArray2080.t, skp:BArray2752.t) : 
  BArray2080.t * BArray2752.t = {
    var seed:BArray32.t;
    var seedp:BArray32.t;
    var ms:W64.t;
  ...
  proc crypto_sign_keypair_mode5_jazz (vkp:BArray2080.t, skp:BArray2752.t) : 
  BArray2080.t * BArray2752.t = {
    var seed:BArray32.t;
    var seedp:BArray32.t;
    var ms:W64.t;
  ...
  proc cryptolab_haetae_mode2_keypair_internal (vku:int, sku:int, seedu:int) : 
  W64.t = {
    var r:W64.t;
    var vk:BArray2080.t;
    ...
    seedp <@ __kp_api_copy_addr_to_32 (seedp, seedua);
    (vkp, skp) <@ crypto_sign_keypair_internal_mode2_jazz (vkp, skp, seedp);
    vkua <@ __kp_api_copy_2080_to_addr (vkua, vkp, (W64.of_int 992));
    skua <@ __kp_api_copy_2752_to_addr (skua, skp, (W64.of_int 1408));
    r <- (W64.of_int 0);
    return r;
  }
  proc cryptolab_haetae_mode3_keypair_internal (vku:int, sku:int, seedu:int) : 
  W64.t = {
    var r:W64.t;
    var vk:BArray2080.t;
    var vkp:BArray2080.t;
    ...
    vkua <@ __kp_api_copy_2080_to_addr (vkua, vkp, (W64.of_int 1472));
    skua <@ __kp_api_copy_2752_to_addr (skua, skp, (W64.of_int 2112));
    r <- (W64.of_int 0);
    return r;
  }
  proc cryptolab_haetae_mode5_keypair_internal (vku:int, sku:int, seedu:int) : 
  W64.t = {
    var r:W64.t;
    var vk:BArray2080.t;
    var vkp:BArray2080.t;
    ...
    vkua <@ __kp_api_copy_2080_to_addr (vkua, vkp, (W64.of_int 2080));
    skua <@ __kp_api_copy_2752_to_addr (skua, skp, (W64.of_int 2752));
    r <- (W64.of_int 0);
    return r;
  }
  proc cryptolab_haetae_mode2_keypair (vku:int, sku:int) : W64.t = {
    var r:W64.t;
    var vk:BArray2080.t;
    var vkp:BArray2080.t;
    var sk:BArray2752.t;
  ...
  proc cryptolab_haetae_mode3_keypair (vku:int, sku:int) : W64.t = {
    var r:W64.t;
    var vk:BArray2080.t;
    var vkp:BArray2080.t;
    var sk:BArray2752.t;
  ...
  proc cryptolab_haetae_mode5_keypair (vku:int, sku:int) : W64.t = {
    var r:W64.t;
    var vk:BArray2080.t;
    var vkp:BArray2080.t;
    var sk:BArray2752.t;
