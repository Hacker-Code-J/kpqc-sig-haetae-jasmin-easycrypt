...
| NTT 외 명세·증명 | `verify-new`의 180개 파일 | EOF 확인을 포함한 새 통합 실행 모두 PASS |
...
전체 로컬 명세·증명 192개를 각 단계에서 주 검증 대상으로 검사했다. import만 된 증명의
...
이번 전체 승인 payload·제곱합 단계에서는 명세·증명 12개를 추가했다.
