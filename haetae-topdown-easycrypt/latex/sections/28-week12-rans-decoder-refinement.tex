...
\[
  bad=0 \;\land\;
  off=\mathit{encoded\_size} \;\land\;
  decoded[0..1024)=expected\_symbols[0..1024) \;\land\;
...
\[
  cursor(0)=4,\qquad
  cursor(i+1)=cursor(i)+|\mathsf{segment}(i)|,\qquad
...
\procname{generated\_decoder\_lookup\_word\_from\_mode2},
\procname{generated\_decoder\_symbol\_from\_mode2}, and
\procname{generated\_decoder\_word\_update\_from\_mode2} connects those exact
