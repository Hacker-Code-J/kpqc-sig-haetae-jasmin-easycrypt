...
\[
\begin{aligned}
  &\mathsf{raw\_prelen}(\ell)\land \prefix_{992}(sk,mem,vk) \\
  &\qquad\Longrightarrow
  \take_{32}\bigl(\mathsf{sf\_mu\_rawpre}(sk,pre,m)\bigr)
  = \mathsf{verify\_hash\_mu}(vk,pre,m).
\end{aligned}
\]
...
\breakablesame{sign_verify_generated_raw_mu_prefix}. Its left and right
...
\breakablesame{keypair_internal_return_reaches_generated_raw_mu_preconditions}
over the actual generated
\breakablett{crypto_sign_keypair_internal_mode2_jazz}. Every terminating
