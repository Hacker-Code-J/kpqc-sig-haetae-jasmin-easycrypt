...
\procname{actual_encode_hb_z1_full_zero_success} opens the actual
\procname{HbzFullEncodeTarget.M._encode_hb_z1_full}.  It derives zero-input
...
\procname{signature_pack_hbz_zero_success_mode2} for
\procname{SignaturePackMode2Target.M._encode_hb_z1_full}.  The additional
corollary \procname{signature_pack_unpack_hbz_zero_success_mode2} eliminates
