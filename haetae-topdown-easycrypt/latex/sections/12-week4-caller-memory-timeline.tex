...
\theoryname{keypair_raw_api_exact_export_trace} places the actual
\procname{cryptolab_haetae_mode2_keypair_internal} on the left of an exact
...
\theoryname{keypair_raw_api_exports_matching_prefixes_from_copy_posts}
