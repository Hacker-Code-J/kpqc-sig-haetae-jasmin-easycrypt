...
\[
\begin{aligned}
\mathsf{encode:}\quad \procname{encode_hb_z1_mode2_full_jazz}
 &\to \procname{_encode_hb_z1_full}\\
 &\to \left\{\begin{gathered}
       \procname{_encode_hb_z1_prepare},\\
       \procname{_rans_encode},\\
       \procname{__copy_encoded_suffix}
       \end{gathered}\right\},\\[2mm]
\mathsf{decode:}\quad \procname{decode_hb_z1_mode2_full_jazz}
 &\to \procname{_decode_hb_z1_full}\\
 &\to \left\{\begin{gathered}
       \procname{_rans_decode},\\
