...
\begin{align*}
  T_i &\eqdef \mathsf{encodeTrace}(\mathsf{symbolSuffix}(symbols_0,i)),\\
  0 &\le i\le1024,\\
...
\[
\begin{aligned}
  S_0&\eqdef\mathsf{symbolListOfArray}(symbols_0),\\
  \mathsf{serialize32LE}(\mathsf{uint}(x))
    \mathbin{++}\mathsf{encodeTrace}(S_0).\mathsf{bytes}
  &=\mathsf{traceBytes}(S_0).
\end{aligned}
\]
