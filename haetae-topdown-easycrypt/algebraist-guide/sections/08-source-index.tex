...
\identifier{STOP-KG-NTT}와 actual accepted Sign core 전환 \\
\bottomrule
\end{longtable}
...
\begin{enumerate}
  ...
  \item \sourcepath{WEEK16_KG_NTT_MUL_REPORT.md}와
        ...
        absent convolution/security-list bridge를 구분하고, 다음
        \claimid{OBL-MINCORE-SIGN}이 아직 \statusspecified 임을 확인한다.
\end{enumerate}
