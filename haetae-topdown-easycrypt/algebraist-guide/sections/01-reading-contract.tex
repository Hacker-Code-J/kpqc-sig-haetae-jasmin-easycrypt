...
\begin{enumerate}
  ...
  \item actual KeyGen matrix/finalize snapshot에서는 KG-2-like 분해와
        ...
        따라서 KeyGen은 \identifier{STOP-KG-NTT}로 동결되었다. 다음 actual
        accepted Sign core는 control만 컴파일되고 canonical decoded \((x,v,h,c)\)
        경계의 \identifier{PARTIAL-VERIFY-MATRIX-CRT} 상태이며, 첫 재개 leaf는
