...
\subsection{7단계 현재: accepted Sign core}

현재 단일 목표는 다음 세 actual helper의 순차 실행을 투명한 harness에서
합성하는 것이다.
\begin{center}
...
\end{center}
계획된 headline theorem은
\sourcepath{Mode2SignAcceptedCore.ec}의
\begin{center}
\theoremname{actual_sign_accepted_core_equations_mode2}
\end{center}
이다.
...
이 정리는 아직 \statusspecified 이며 컴파일된 증명으로 세어서는 안 된다.
