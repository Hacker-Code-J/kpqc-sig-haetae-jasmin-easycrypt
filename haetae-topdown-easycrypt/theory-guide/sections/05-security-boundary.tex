...
\identifier{STOP-KG-NTT}로 동결된다. 이후 Sign actual-call control도
컴파일됐지만 canonical decoded \((x,v,h,c)\) 경계의
\identifier{PARTIAL-VERIFY-MATRIX-CRT}가 현재 활성 전선이며, V-1/V-2/V-5/V-6,
W64 norm gate, tail trace/mismatch word expression만 proved로 남고 matrix 및
challenge blocker는 열려 있다.
