...
\begin{enumerate}
  ...
  \item Week~9 rANS 정리 표면에 더해 Week~10 배열/목록, 단어 단계, 내부 진행,
        ...
        직접 Sign/Verify core control과 \identifier{PARTIAL-VERIFY-MATRIX-CRT}
        표면 검사;
...
\((x,v,h,c)\) 경계의 \identifier{PARTIAL-VERIFY-MATRIX-CRT}와 남은 blocker를
설명한다. 최종 82/82 aggregate 로그는
\sourcepath{logs/verify-all-week16-verify.log}에 보존되고 SHA-256은
\texttt{46e7dac8e442c820f746139a164c8bc00d6af17b7ad25cbd5d195507fddae03c}이다.
...
\sourcepath{logs/verify-all-before-week16-verify.log}에 보존되며,
최종 82/82 aggregate는 \sourcepath{logs/verify-all-week16-verify.log}에
보존된다. 그 밖의
