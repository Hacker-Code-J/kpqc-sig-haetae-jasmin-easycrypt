...
\identifier{PARTIAL-VERIFY-MATRIX-CRT}이며 제한 합성은 \statusspecified 다.
Verify의 첫 재개 leaf는
...
\identifier{PARTIAL-VERIFY-MATRIX-CRT} & actual helper 순서, V-1/V-2/V-5/V-6
...
\begin{enumerate}
  ...
  \item \identifier{STOP-SIGN-CHAL-MODE2}를 유지한다. full
        ...
        S-1--S-7을 주장하지 않는다.
  \item Verify의 첫 누락 leaf
        \identifier{verify_matrix_crt_mode2_fromcrt_freeze_exact}를 닫고, 그 다음
        downstream challenge leaf와 decoded-object 제한 합성을 닫는다.
