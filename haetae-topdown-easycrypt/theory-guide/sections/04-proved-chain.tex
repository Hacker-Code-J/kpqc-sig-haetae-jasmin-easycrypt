...
전체 KG-4 및 논문 식은 증명되지 않았다. KeyGen 전선은 이 경계에서 동결되고
활성 단일 목표는
\identifier{Mode2SignAcceptedCore.actual_sign_accepted_core_equations_mode2}로
이동한다. 현재 77대상 매니페스트와 77번째 대상의 개별 컴파일은 확인됐지만,
전체 77대상 완료 표식은 아직 없다. 완료 판정은
\cref{sec:trust-reproduction}의 로그 기준을 따른다.
