...
leaf/table부터 Week~9 byte-stack/copy/harness까지의 상태와 success boundary \\
...
67개 작성 대상 전체 검증이 통과했고 최신 판정은 \identifier{GO-CORE}다. 다음
단일 의무는 이 핵심 역함수와 prepare/apply 역함수를 production 전체 HBZ
래퍼에서 합성하는 것이다. 실제 성공 증인과 종료, h 역함수, 크기 메타데이터와
영 패딩도 남아 있다. 문맥, highbits/LSB, 확률분포와 게임 기반 보안은 여전히
별도 의무다.
\end{takeaway}
