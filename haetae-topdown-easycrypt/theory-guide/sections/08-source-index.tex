...
합성 경계, (h) 코덱 연기, KeyGen stop 결정과 활성 Sign 전선 \\
...
\begin{description}[style=nextline,leftmargin=3.1cm]
  ...
  Week~16 최소 논문 범위. KeyGen은 부분/중단, Sign은 활성 명세, Verify와 제한
  합성은 후속 명세 상태다.
...
주장할 수 없다. KeyGen은 KG-2/finalization에서 동결됐고 현재 단일 목표는
actual accepted Sign core다. (h) 코덱은 연기됐으며 MINCORE Verify/합성, 종료,
문맥, highbits/LSB, 확률분포와 게임 기반 보안은 여전히 별도 의무다. 수정 전
76대상 기준선만 전체 완료로 보존되며, 최종 77대상 aggregate 완료 로그는 아직
없다.
\end{takeaway}
